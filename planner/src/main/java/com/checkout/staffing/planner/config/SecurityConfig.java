        ...
        .authorizeHttpRequests(
            request ->
                request
                    ...
                    .hasRole("OWNER")
                    .requestMatchers(HttpMethod.POST, "/api/properties/*/assign")
                    .hasRole("OWNER")
                    .requestMatchers(HttpMethod.PATCH, "/api/properties/*")
                    .hasRole("OWNER")
                    .requestMatchers(HttpMethod.DELETE, "/api/properties/*")
                    .hasRole("OWNER")
                    .requestMatchers("/api/tenants")
                    .hasRole("OWNER")
                    .requestMatchers(("/api/properties/summary-owner"))
                    .hasRole("OWNER")
                    .requestMatchers(("/api/properties/summary-tenant"))
                    .hasRole("TENANT")
                    .requestMatchers(HttpMethod.POST, "/api/properties/requests")
                    .hasRole("TENANT")
                    .requestMatchers(HttpMethod.POST, "/api/properties/requests/*/complete")
                    .hasRole("TENANT")
                    .requestMatchers("/image-uploads/**")
                    .permitAll()
                    .anyRequest()
                    .authenticated())
